#ifndef ShoreDocker2_H
#define ShoreDocker2_H
...
class ShoreDocker {
    ...
    */
    ...
    private:
        ...
        cv::Mat_<uint8_t> empty_frame_;
        cv::Mat_<cv::Vec3b> frame_;
        cv::Mat_<uint8_t> frame_sc_;
        cv::Mat_<uint8_t> gaussian_kernel_;
        cv::Mat_<uint8_t> rgb_[3];
        ...
        void refreshFrame();
        void setMaxBlockValue(int, int, cv::Mat_<uint8_t>&, int, cv::Mat_<uint8_t>&);
        void addToBuffer(const sensor_msgs::LaserScanConstPtr &);
        void filterPoints(PointsVector&, PointsVector&);
        void drawShore();
        void drawBoey();
        void drawGaussian(cv::Mat_<cv::Vec3b>&, double, double, double, int, int);
        void precomputeGaussian(cv::Mat_<uint8_t>&, double, int);
