...
class DreamerAgent:
    ...
    def imageCallback(self, obs):
        ...
        if not self.Done:
            ...
            # Record
            self.incrementEpisode(self.obs['image'][0], self.actions, self.obs['reward'][0], self.obs['physics'][0], self.obs['physics_d'][0])
    ...
    def incrementEpisode(self, img, act, reward, phy, phy_d):
